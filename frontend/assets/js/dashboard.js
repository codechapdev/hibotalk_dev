(function($) {
  ...
  $(function() {
    ...
    if ($("#performanceLinenew").length) { 
      const ctx = document.getElementById('performanceLinenew');
      var graphGradient = document.getElementById("performanceLinenew").getContext('2d');
      var graphGradient2 = document.getElementById("performanceLinenew").getContext('2d');
      var saleGradientBg = graphGradient.createLinearGradient(5, 0, 5, 100);
      saleGradientBg.addColorStop(0, 'rgba(26, 115, 232, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(26, 115, 232, 0.02)');
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
    ...
    if ($("#marketingOverviewnew").length) { 
      const marketingOverviewCanvas = document.getElementById('marketingOverviewnew');
      new Chart(marketingOverviewCanvas, {
        type: 'bar',
        data: {
          labels: ["Paris","Marseille", "Toulouse", "Lyon", "Nice", "Nantes", "Strasbourg", "Montpellier", "Bordeaux", "Toulon", "Dijon", "Grenoble"],
          datasets: [{
            label: 'Last week',
            data: [110, 220, 200, 190, 220, 110, 210, 110, 205, 202, 201, 150],
            backgroundColor: "#52CDFF",
    ...
    if ($("#leaveReport").length) { 
      ...
      new Chart(leaveReportCanvas, {
        type: 'bar',
        data: {
          labels: ["Location1","Location2", "Location1", "Location4", "Location5"],
          datasets: [{
              label: 'Last week',
              data: [18, 25, 39, 11, 24],
              backgroundColor: "#52CDFF",
